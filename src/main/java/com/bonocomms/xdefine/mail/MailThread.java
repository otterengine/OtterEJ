package com.bonocomms.xdefine.mail;
...
public class MailThread extends Thread {
	...
	public void run() {
		...
		try {
			...
			mimeMessageHelper.setFrom(new InternetAddress(XFContext.getProperty("webapp.mail.display.mail"), XFContext.getProperty("webapp.mail.display.name")));
