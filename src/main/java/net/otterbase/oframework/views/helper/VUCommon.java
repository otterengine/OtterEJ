package net.otterbase.oframework.views.helper;
...
import net.otterbase.oframework.common.CookieHelper;
...
public class VUCommon {
	...
	public static String getParams(List<String> arr, String prefix) {
		...
		for (String query : queries) {
			if (arr != null && arr.size() > 0 && arr.contains(query.substring(0, query.indexOf("=")))) continue;
			params.append("&" + query);
		}
