...
public class VUHtmlTag {
	...
	public String param(String key) {
		if (ServletContextHolder.getInstance().getRequest().getParameterValues(key) == null) return null;
		return org.apache.commons.lang.StringUtils.join(ServletContextHolder.getInstance().getRequest().getParameterValues(key), ",");
	}
